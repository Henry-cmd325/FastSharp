...
Run the project and open `/openapi` — you'll see all 6 endpoints ready to use.
...
| `GET` | `/api/products/list` | Full list |
...
- 📦 [Quick Start — in-memory database](examples/quickstart)
- 🏗 [Full example — SQL Server + migrations](examples/full)
